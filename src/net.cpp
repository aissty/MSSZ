...
void ThreadMapPort()
{
    ...
    if (r == 1)
    {
        ...
        string strDesc = "Msszcoin " + FormatFullVersion();
...
static const char *strMainNetDNSSeed[][2] = {
   // {"msszcointools.com", "dnsseed.msszcointools.com"},
    //{"msszcoinpool.org", "dnsseed.msszcoinpool.org"},
...
static const char *strTestNetDNSSeed[][2] = {
    //{"msszcointools.com", "testnet-seed.msszcointools.com"},
...
bool BindListenPort(const CService &addrBind, string& strError)
{
    ...
    if (::bind(hListenSocket, (struct sockaddr*)&sockaddr, len) == SOCKET_ERROR)
    {
        ...
        if (nErr == WSAEADDRINUSE)
            strError = strprintf(_("Unable to bind to %s on this computer. Msszcoin is probably already running."), addrBind.ToString().c_str());
        else
